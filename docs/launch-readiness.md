...
- [x] Public branch Preview smoke QA at commit `328eb18b9d5ce0d85517498bd0bc23a825320f44` passed on 2026-09-11 across clean vehicle selection, marketplace browse, product detail, sellers, garages, seller entry, account entry and trust/policy routes. The current branch Preview is `https://second-part-shop-git-rebuild-nextjs-joannakwapis11-5369.vercel.app`; the convenience alias `second-part-shop-preview.vercel.app` was subsequently synchronized to the verified current Preview during commerce QA; always recheck its SHA before RC review.
