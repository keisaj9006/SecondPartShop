...
- GitHub Actions `35008872581`: full PASS, including 545/545 tests, release validators, build, true last-stock concurrency and isolated 100k marketplace PostgreSQL proof
- Vercel Preview `dpl_8pY6HUNC1kb67wsrqfTWXiiQGc3N`: READY on exact SHA
- temporary QA actor/bootstrap routes remain removed; `/qa/actor-switch` and `/api/qa/actor-switch` return 404
...
| Monitoring / diagnosis | **VERIFIED engineering; EXTERNAL real alert receipt** | Redaction/sanitization, structured diagnostics and privacy-safe CSV operation/code evidence pass. Preview public smoke plus runtime observation found no error/fatal logs or 5xx requests in checked windows; the exact public-listing privacy deployment also recorded 0 error/fatal and 0 5xx after live API probes. No approved alert test destination configured; do not claim receipt. `2026-09-15-p0-monitoring-diagnosis.md`, `2026-09-15-preview-public-smoke.md`, `2026-09-15-public-listing-privacy.md`. |
...
| Web / Android | **Web + anonymous public Preview scoped VERIFIED; physical Android EXTERNAL** | Mobile/web navigation/responsive code and validators pass. Current anonymous Preview smoke returned healthy routes for marketplace home, active listing detail, seller profile/directory, Contact, Privacy and Garages. The public mobile marketplace/listing endpoints also returned 200 with the minimized buyer-facing projection on exact SHA `37940ae`. Signed physical-device app links, FCM, uploads and external-return checks remain manual/device gates. `2026-09-15-preview-public-smoke.md`, `2026-09-15-public-listing-privacy.md`. |
