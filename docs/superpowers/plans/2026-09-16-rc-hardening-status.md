...
- SHA `757275da2222b69da819aca7b1207b9644c47108`
- GitHub Actions `35110601856`: **SUCCESS**
...
- exact Vercel Preview `dpl_7ihCaS3s7J1QK4nDVDoz1TWnFQtn`
- exact Preview URL `https://second-part-shop-i6cxcvk4p-joannakwapis11-5369.vercel.app`
...
## Newly closed / hardened on 2026-09-16
...
| Privacy / deletion / retention | **VERIFIED deployed preflight; destructive E2E OPEN / legal EXTERNAL** | Full Auth+DB+Storage destruction still needs a fresh disposable legitimately confirmed account. The 2026-09-16 attempt reached a real email but failed at the old PKCE confirmation boundary; manual `email_confirmed_at` mutation was rejected. Token-hash app support is now ready, but Supabase Auth templates still need controlled configuration before retry. |
