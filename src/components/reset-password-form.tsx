...
export function ResetPasswordForm({mobileReturn=false}:{mobileReturn?:boolean}){
 ...
 return <div className="w-full max-w-md rounded-3xl border border-black/10 bg-white p-8 shadow-xl">
  ...
  <form action={action} className="mt-6">{mobileReturn&&<input type="hidden" name="mobileReturn" value="1"/>}
