...
export function ProductGallery({images,alt}:{images:ListingImage[];alt:string}){
 ...
 return <div>
  <div className="relative h-[360px] overflow-hidden rounded-[28px] border border-black/10 bg-[#e8ebe5] sm:h-auto sm:min-h-[520px]"><Image src={selected.url} alt={selected.alt||alt} fill priority sizes="(max-width: 1024px) 100vw, 55vw" className="object-cover"/></div>
