...
export default async function SellerVerificationPage(){
 ...
 const {data:request}=await supabase
  ...
  .select("status,requested_at,reviewed_at,review_note,legal_business_name,business_reference,reference_url,business_name_snapshot,business_kind_snapshot,location_snapshot,postcode_snapshot")
