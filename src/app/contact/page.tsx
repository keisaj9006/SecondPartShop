...
const statusLabels={open:"Submitted",in_progress:"In review",closed:"Closed"} as const;
const statusClasses={
...
export default async function ContactPage(){
 ...
 return <><Header/><main className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
  ...
  {user&&<section className="mt-6 rounded-3xl border border-black/10 bg-white p-6">
   ...
   <p className="mt-2 text-sm leading-6 text-[#63706a]">Track whether an account-linked request has been submitted, is being reviewed or has been closed. This status reflects triage; it does not promise an in-app reply.</p>
