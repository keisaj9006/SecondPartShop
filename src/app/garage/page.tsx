...
export default async function GaragePage(){
 ...
 return <><Header/><main className="mx-auto max-w-5xl px-4 py-8 sm:px-6 sm:py-12">
  ...
  <div className="mt-3 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
   ...
   <Link href="/?addVehicle=1#marketplace" className="w-fit rounded-full bg-[#173c31] px-5 py-3 text-sm font-black text-white">Add a vehicle</Link>
  </div>
