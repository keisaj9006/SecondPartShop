...
export default function PrivacyPage(){
 return <><Header/><main className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
  ...
  <p className="mt-4 rounded-2xl bg-amber-50 p-4 text-sm font-bold text-amber-900">This policy reflects the current SecondPart product architecture. Developer identity/contact details and final legal retention periods must be verified before public production launch.</p>
  ...
  <div className="mt-8 space-y-8 text-sm leading-7 text-[#4f5e57]">
   ...
   <section><h2 className="text-xl font-black text-[#12221d]">Questions and privacy requests</h2><p className="mt-2">Signed-in users can use the <Link href="/contact" className="font-black text-[#287154] underline">SecondPart support form</Link>. A public privacy contact email matching the final Google Play developer identity will be added before production publication.</p></section>
  </div>
 </main></>;
}
