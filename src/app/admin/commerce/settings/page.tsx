...
export default async function CommerceSettingsPage(){
 ...
 const {data}=await admin
  ...
  .select("platform_fee_bps,checkout_reservation_minutes,auto_release_hours")
  .eq("singleton",true)
  .maybeSingle();
 ...
 return <><Header/><main className="mx-auto max-w-4xl px-4 py-10 sm:px-6 sm:py-14">
  ...
  <CommerceSettingsForm platformFeePercent={fee} checkoutReservationMinutes={reservation} autoReleaseHours={release}/>
 </main></>;
}
