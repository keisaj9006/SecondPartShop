...
const checks=[
 ...
 ["Runbook must prohibit direct Storage schema manipulation",runbook.includes("Never mutate `storage.objects` directly")&&runbook.includes("Storage API")],
 ...
 ["Runbook must test retained transaction-case evidence",runbook.includes("Scenario F — Retained transaction-case evidence")&&runbook.includes("caseId/retained/evidenceId.ext")&&runbook.includes("hard Supabase Auth deletion succeeds despite the retained file")],
