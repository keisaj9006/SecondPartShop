...
const checks=[
 ...
 ["Android Preview must keep loading the full Next.js frontend",previewPrep.includes("second-part-shop-git-rebuild-nextjs-joannakwapis11-5369.vercel.app")&&previewPrep.includes("config.server=")],
