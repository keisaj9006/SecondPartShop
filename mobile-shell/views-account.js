...
const account=async(payload)=>{
 ...
 if(mode==="buying"){
  ...
  if(!seller){
   ...
   html.push("<section class=\"account-grid\" style=\"margin-top:14px\"><button class=\"account-tile\" id=\"account-seller\" type=\"button\"><strong>Seller dashboard</strong><small>Readiness, sales, payouts, fulfilment and cases.</small></button><button class=\"account-tile\" id=\"account-inventory\" type=\"button\"><strong>Inventory</strong><small>Create, edit and photograph listings.</small></button><button class=\"account-tile\" id=\"account-seller-requests\" type=\"button\"><strong>Buyer requests</strong><small>Open privacy-safe demand leads from buyers who could not find a part.</small></button><button class=\"account-tile\" id=\"account-donors\" type=\"button\"><strong>Donor vehicles</strong><small>Reuse source-vehicle details across many listings.</small></button><button class=\"account-tile\" id=\"account-seller-profile\" type=\"button\"><strong>Seller profile</strong><small>Edit your public seller identity and location.</small></button>"+(seller.sellerType==="business"?"<button class=\"account-tile\" id=\"account-seller-verification\" type=\"button\"><strong>Business verification</strong><small>"+(seller.verified?"Verified business":"Verification status and request")+".</small></button>":"")+"<button class=\"account-tile\" id=\"account-reviews\" type=\"button\"><strong>Reviews</strong><small>Rate completed buyers and see review opportunities.</small></button><button class=\"account-tile\" id=\"account-inbox\" type=\"button\"><strong>Buyer questions</strong><small>Pre-purchase messages about your parts.</small></button><button class=\"account-tile\" id=\"account-notifications\" type=\"button\"><strong>Seller notifications</strong><small>"+C.escapeHtml(C.state.unreadNotifications)+" unread update(s).</small></button><button class=\"account-tile\" id=\"account-cases\" type=\"button\"><strong>Returns & cases</strong><small>Transaction problems and evidence.</small></button><button class=\"account-tile\" id=\"account-new-listing\" type=\"button\"><strong>Create listing</strong><small>Add a part directly from the app.</small></button></section>");
  }
 }
