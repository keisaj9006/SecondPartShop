...
const refreshActiveScreen=async()=>{
 ...
 if(["orders","order","inbox","conversation","transactionChat","seller","sellerSales","inventory","notifications","saved","savedSearches","recentlyViewed","requests","sellerRequests","sellerDonors","garage"].includes(C.state.currentView)){
